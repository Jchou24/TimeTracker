...
namespace TimeTracker.Migrations
{
    ...
    [Migration("20201225064853_InitialCreate")]
            ...
            modelBuilder.Entity("TimeTracker.DAL.DBModels.Auth.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Admin",
                            PasswordHash = "$MYHASH$V1$10000$UG0EFqmV3wlEKXnKg0rhEyFu1Wx9n0xLmQgvSONhzK4MsRgu",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Guid = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "User",
                            PasswordHash = "$MYHASH$V1$10000$c3qRQFd8WU2j6GbIi9M95vtqH0grXljVFJLtiYfAYD4z4zkK",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Guid = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Test",
                            PasswordHash = "$MYHASH$V1$10000$8tyGtmB9OkFYBjhRre3m7zdcwnAlE98KQNAPYGjkBP6Q8Llo",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Guid = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Test2",
                            PasswordHash = "$MYHASH$V1$10000$TRrqfvZI6VwikxE4i1US3lWFUNEBZuwf2QHf+LZGRQ8eg7w2",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("TimeTracker.DAL.DBModels.Auth.UserImage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Guid = new Guid("02d226f7-9466-4ad8-ab14-b24b0d17f076"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Guid = new Guid("0dae9d04-af2d-4ca2-baed-4027b3e0989f"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("TimeTracker.DAL.DBModels.Task.DayWorkLimitTime", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Guid = new Guid("eeca398c-d7e5-45d8-b991-453c1026dba3"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LimitWorkTime = 7.5,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
            ...
            modelBuilder.Entity("TimeTracker.DAL.DBModels.Task.Period", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Guid = new Guid("21d9a818-815a-4fe3-8dbc-fb65b5782ea6"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("TimeTracker.DAL.DBModels.Task.Task", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Guid = new Guid("30c9c089-7fb8-4e98-a07b-5631a8641c04"),
                            ConsumeTime = 4.0,
                            Date = new DateTime(2020, 12, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayOrder = 0,
                            TaskContent = "Architecture design",
                            TaskDayGuid = new Guid("43461fcc-6b88-4cff-8b17-f689f9a25ccd"),
                            TaskName = "Track Time",
                            TaskSourceGuid = new Guid("4cdd52e4-80e0-4f88-a255-5f74f21afbb5"),
                            TaskTypeGuid = new Guid("d722b683-184e-4bbd-95d4-29f38313a3bf")
                        },
                        new
                        {
                            Guid = new Guid("2e2556c7-ecd9-46bc-8001-9fcb245ac442"),
                            ConsumeTime = 3.0,
                            Date = new DateTime(2020, 12, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayOrder = 1,
                            TaskContent = "",
                            TaskDayGuid = new Guid("43461fcc-6b88-4cff-8b17-f689f9a25ccd"),
                            TaskName = "FEZ",
                            TaskSourceGuid = new Guid("9011aa04-3ebf-414e-ac72-04072914850b"),
                            TaskTypeGuid = new Guid("44c8d5d8-993c-4cf8-92fd-c4a9d2a23a3e")
                        },
                        new
                        {
                            Guid = new Guid("c6147787-eb81-4a60-b883-aa357c964678"),
                            ConsumeTime = 3.0,
                            Date = new DateTime(2020, 12, 11, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayOrder = 0,
                            TaskContent = "AAAAA",
                            TaskDayGuid = new Guid("7acab969-b577-4838-9104-cf08bca61a65"),
                            TaskName = "",
                            TaskSourceGuid = new Guid("9011aa04-3ebf-414e-ac72-04072914850b"),
                            TaskTypeGuid = new Guid("c83765ad-7039-4c2c-9b26-88fdd370de8f")
                        },
                        new
                        {
                            Guid = new Guid("3dc732b4-2c11-4500-bc15-d87b50d8f7fe"),
                            ConsumeTime = 0.0,
                            Date = new DateTime(2020, 12, 11, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayOrder = 1,
                            TaskContent = "",
                        ...
                        new
                        {
                            Guid = new Guid("5d047c8f-d0d3-4986-abbe-156aa60c27ab"),
                            ConsumeTime = 2.0,
                            Date = new DateTime(2020, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayOrder = 0,
                            TaskContent = "hooooooooooo",
                            TaskDayGuid = new Guid("9e065c69-6e61-485f-9d79-7963fb3d8bb2"),
                            TaskName = "Yeah",
                            TaskSourceGuid = new Guid("3f23ed8a-16f7-4932-9c49-c75907acb4c6"),
                            TaskTypeGuid = new Guid("844a9736-80eb-4050-9d9f-343e323de3da")
                        },
                        new
                        {
                            Guid = new Guid("d2caf5cc-33cd-493e-b4c4-88e1fb2710f0"),
                            ConsumeTime = 4.5,
                            Date = new DateTime(2020, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayOrder = 1,
                            TaskContent = "",
                        ...
                        new
                        {
                            Guid = new Guid("c73ccd21-96c7-44d2-a46a-44cf95292f67"),
                            ConsumeTime = 4.0,
                            Date = new DateTime(2020, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayOrder = 2,
                        ...
                        new
                        {
                            Guid = new Guid("6f7aaca6-3c01-46dc-acb6-5cb877d2ba1e"),
                            ConsumeTime = 1.5,
                            Date = new DateTime(2020, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayOrder = 3,
                        ...
                        new
                        {
                            Guid = new Guid("de60dc86-6c6d-4299-ab8f-d370e3045b98"),
                            ConsumeTime = 7.0,
                            Date = new DateTime(2020, 12, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayOrder = 0,
                            TaskContent = "",
                            TaskDayGuid = new Guid("975c0e72-0173-4138-ad8b-42752a72f75d"),
                            TaskName = "",
                            TaskSourceGuid = new Guid("9011aa04-3ebf-414e-ac72-04072914850b"),
                            TaskTypeGuid = new Guid("c83765ad-7039-4c2c-9b26-88fdd370de8f")
                        },
                        new
                        {
                            Guid = new Guid("fe3b3b56-cef6-4365-b0f9-72e6b4c2b7a9"),
                            ConsumeTime = 4.5,
                            Date = new DateTime(2020, 12, 14, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayOrder = 0,
                            TaskContent = "",
                            TaskDayGuid = new Guid("09ee5458-74de-4921-a854-af83c5c978da"),
                            TaskName = "",
                            TaskSourceGuid = new Guid("9011aa04-3ebf-414e-ac72-04072914850b"),
                            TaskTypeGuid = new Guid("c83765ad-7039-4c2c-9b26-88fdd370de8f")
                        },
                        new
                        {
                            Guid = new Guid("5abccdef-1290-4630-b7cd-26d28c290eee"),
                            ConsumeTime = 3.0,
                            Date = new DateTime(2020, 12, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayOrder = 0,
                            TaskContent = "",
                            TaskDayGuid = new Guid("25c4ef2b-f433-4c6f-b7cf-78ea19439b88"),
                            TaskName = "",
                            TaskSourceGuid = new Guid("9011aa04-3ebf-414e-ac72-04072914850b"),
                            TaskTypeGuid = new Guid("c83765ad-7039-4c2c-9b26-88fdd370de8f")
                        },
                        new
                        {
                            Guid = new Guid("9296aeef-8448-4a8f-b1da-dc1b7d8fdf6e"),
                            ConsumeTime = 2.0,
                            Date = new DateTime(2020, 12, 11, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayOrder = 0,
                            TaskContent = "",
                            TaskDayGuid = new Guid("d96ad9d9-87e2-42bd-acc1-64fbb33f58a1"),
                            TaskName = "",
                            TaskSourceGuid = new Guid("9011aa04-3ebf-414e-ac72-04072914850b"),
                            TaskTypeGuid = new Guid("c83765ad-7039-4c2c-9b26-88fdd370de8f")
                        },
                        new
                        {
                            Guid = new Guid("9f5fd4fc-06c9-421c-8a6d-d022e88662e6"),
                            ConsumeTime = 3.0,
                            Date = new DateTime(2020, 12, 11, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayOrder = 1,
                            TaskContent = "",
                        ...
                        new
                        {
                            Guid = new Guid("fee7d623-74ab-4943-8c09-6f23cbdda3c5"),
                            ConsumeTime = 5.0,
                            Date = new DateTime(2020, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayOrder = 0,
                            TaskContent = "",
                            TaskDayGuid = new Guid("9747d4da-d3f5-4a8a-8eb3-db160888ff47"),
                            TaskName = "",
                            TaskSourceGuid = new Guid("9011aa04-3ebf-414e-ac72-04072914850b"),
                            TaskTypeGuid = new Guid("c83765ad-7039-4c2c-9b26-88fdd370de8f")
                        });
            ...
            modelBuilder.Entity("TimeTracker.DAL.DBModels.Task.TaskDay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Guid = new Guid("43461fcc-6b88-4cff-8b17-f689f9a25ccd"),
                            Date = new DateTime(2020, 12, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsLeave = false,
                            UserId = 1
                        },
                        new
                        {
                            Guid = new Guid("7acab969-b577-4838-9104-cf08bca61a65"),
                            Date = new DateTime(2020, 12, 11, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsLeave = false,
                            UserId = 1
                        },
                        new
                        {
                            Guid = new Guid("9e065c69-6e61-485f-9d79-7963fb3d8bb2"),
                            Date = new DateTime(2020, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsLeave = false,
                            UserId = 1
                        },
                        new
                        {
                            Guid = new Guid("975c0e72-0173-4138-ad8b-42752a72f75d"),
                            Date = new DateTime(2020, 12, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsLeave = true,
                            UserId = 1
                        },
                        new
                        {
                            Guid = new Guid("09ee5458-74de-4921-a854-af83c5c978da"),
                            Date = new DateTime(2020, 12, 14, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsLeave = false,
                            UserId = 1
                        },
                        new
                        {
                            Guid = new Guid("53a1f74b-d55e-42d1-9e3f-d04c09a8bcbc"),
                        ...
                        new
                        {
                            Guid = new Guid("25c4ef2b-f433-4c6f-b7cf-78ea19439b88"),
                            Date = new DateTime(2020, 12, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsLeave = false,
                            UserId = 2
                        },
                        new
                        {
                            Guid = new Guid("d96ad9d9-87e2-42bd-acc1-64fbb33f58a1"),
                            Date = new DateTime(2020, 12, 11, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsLeave = false,
                            UserId = 2
                        },
                        new
                        {
                            Guid = new Guid("9747d4da-d3f5-4a8a-8eb3-db160888ff47"),
                            Date = new DateTime(2020, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsLeave = false,
                            UserId = 2
                        });
            ...
            modelBuilder.Entity("TimeTracker.DAL.DBModels.Task.TaskSource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Guid = new Guid("9011aa04-3ebf-414e-ac72-04072914850b"),
                            CodeName = "default",
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "",
                            IsActive = true,
                        ...
                        new
                        {
                            Guid = new Guid("4cdd52e4-80e0-4f88-a255-5f74f21afbb5"),
                            CodeName = "Boss",
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Boss",
                            IsActive = true,
                        ...
                        new
                        {
                            Guid = new Guid("bb2ef3d5-b311-416b-a08c-e88fab37e947"),
                        ...
                        new
                        {
                            Guid = new Guid("3f23ed8a-16f7-4932-9c49-c75907acb4c6"),
                            CodeName = "Father",
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Father",
                            IsActive = true,
                        ...
                        new
                        {
                            Guid = new Guid("00dd6088-4990-4da8-af5b-057ee11a0e59"),
                            CodeName = "Mother",
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Mother",
                            IsActive = true,
            ...
            modelBuilder.Entity("TimeTracker.DAL.DBModels.Task.TaskType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Guid = new Guid("c83765ad-7039-4c2c-9b26-88fdd370de8f"),
                            CodeName = "default",
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "",
                            IsActive = true,
                        ...
                        new
                        {
                            Guid = new Guid("d722b683-184e-4bbd-95d4-29f38313a3bf"),
                            CodeName = "Coding",
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Coding",
                            IsActive = true,
                        ...
                        new
                        {
                            Guid = new Guid("a03b37b5-1de9-4180-864f-13d7c3c1c6b7"),
                            CodeName = "Shopping",
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Guid = new Guid("844a9736-80eb-4050-9d9f-343e323de3da"),
                        ...
                        new
                        {
                            Guid = new Guid("b9b7aa9e-dbb1-41e1-b0cd-ed6f0ef00ba6"),
                        ...
                        new
                        {
                            Guid = new Guid("2aeaa906-60ed-4e55-9db3-392b6859cf94"),
                            CodeName = "Reading",
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Reading",
                            IsActive = true,
                        ...
                        new
                        {
                            Guid = new Guid("44c8d5d8-993c-4cf8-92fd-c4a9d2a23a3e"),
